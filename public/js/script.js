...
document.addEventListener('DOMContentLoaded', function() {
    ...
    create_item_button_confirm.addEventListener("click", function() {
      ...
      document.querySelector("#input_code").value = document.querySelector("#input_code").defaultValue;
    ...
    document.querySelector(".create_item_quantity_minus").addEventListener("click", function() {
      var quantity = document.querySelector("#input_quantity").value;
      if (quantity > 1) {
        quantity--;
      }
    ...
    document.querySelector(".create_item_quantity_plus").addEventListener("click", function() {
      var quantity = document.querySelector("#input_quantity").value;
      if (quantity < 100) {
        quantity++;
      }
    ...
    document.querySelector("#btn_ordine_al_gruppo").addEventListener("click", function() {
      updateGruppo();
      document.querySelector(".left_tab_body").style.display = "none";
      document.querySelector(".right_tab_body").style.display = "block";
      ...
      // Assuming you have an unordered list with an id "myList"
      ...
      for (const [key, value] of Object.entries(order_list)) {
        ...
        // Crea un nuovo elemento nella lista ul
        var li = document.createElement("li");
        li.innerHTML = '<span class="dish_code">'+key+'</span>-<span class="dish_qantity">'+value+'</span><ul class="right_tab_ul_level_3"><li>Me <span class="user_quantity">'+value+'</span></li></ul>';
        // Aggiungi l'elemento alla lista ul
